...
define default void @_Z_ocelotTranslated__Z17test_madcc_hi_u32Pj( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_2_2:
	...
	%r2 = bitcast i32 131072 to i32;
	%r3 = bitcast i32 -1 to i32;
	%rt3 = zext i32 %r2 to i64;
	%rt4 = zext i32 %r2 to i64;
	%rt5 = mul i64 %rt3, %rt4;
	%rt6 = lshr i64 %rt5, 32;
	%rt7 = trunc i64 %rt6 to i32;
	%r5 = add i32 %rt7, %r3;
	%rt8 = icmp ult i32 %r5, %rt7;
	%rt9 = icmp ult i32 %r5, %r3;
	%rt10 = or i1 %rt8, %rt9;
	%r4 = select i1 %rt10, i32 1, i32 0;
	%rt11 = add i32 0, 0;
	%r6 = add i32 %rt11, %r4;
	%rt12 = inttoptr i64 %r1 to i32*;
	store i32 %r6, i32* %rt12, align 4;
