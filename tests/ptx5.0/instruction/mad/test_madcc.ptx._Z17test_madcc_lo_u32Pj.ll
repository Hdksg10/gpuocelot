...
define default void @_Z_ocelotTranslated__Z17test_madcc_lo_u32Pj( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_1_2:
	...
	%r2 = bitcast i32 2 to i32;
	%r3 = bitcast i32 -1 to i32;
	%rt3 = mul i32 %r2, %r2;
	%r5 = add i32 %r3, %rt3;
	%rt4 = icmp ult i32 %r5, %r3;
	%rt5 = icmp ult i32 %r5, %rt3;
	%rt6 = or i1 %rt4, %rt5;
	%r4 = select i1 %rt6, i32 1, i32 0;
	%rt7 = add i32 0, 0;
	%r6 = add i32 %rt7, %r4;
	%rt8 = inttoptr i64 %r1 to i32*;
	store i32 %r6, i32* %rt8, align 4;
