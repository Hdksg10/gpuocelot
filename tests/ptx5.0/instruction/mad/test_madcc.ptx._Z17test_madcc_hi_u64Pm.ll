...
define default void @_Z_ocelotTranslated__Z17test_madcc_hi_u64Pm( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%r2 = bitcast i64 8589934592 to i64;
	%r3 = bitcast i64 -1 to i64;
	%rt3 = call i64 @__ocelot_mul_hi_u64(i64 %r2, i64 %r2);
	%r5 = add i64 %rt3, %r3;
	%rt4 = icmp ult i64 %r5, %rt3;
	%rt5 = icmp ult i64 %r5, %r3;
	%rt6 = or i1 %rt4, %rt5;
	%r4 = select i1 %rt6, i32 1, i32 0;
	%rt7 = add i64 0, 0;
	%rt8 = sext i32 %r4 to i64;
	%r6 = add i64 %rt7, %rt8;
	%rt9 = inttoptr i64 %r1 to i64*;
	store i64 %r6, i64* %rt9, align 8;
	%rt10 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt11 = load i8*, i8** %rt10;
	%rt12 = bitcast i8* %rt11 to i32*;
	store i32 2, i32* %rt12;
	br label %BB_4_1;
BB_4_1:
	ret void;
