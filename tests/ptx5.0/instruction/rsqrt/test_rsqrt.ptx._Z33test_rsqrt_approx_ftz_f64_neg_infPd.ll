...
define default void @_Z_ocelotTranslated__Z33test_rsqrt_approx_ftz_f64_neg_infPd( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_5_2:
	...
	%r2 = bitcast double 0xfff0000000000000 to double;
