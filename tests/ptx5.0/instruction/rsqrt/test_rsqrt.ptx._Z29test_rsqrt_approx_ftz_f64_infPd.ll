...
define default void @_Z_ocelotTranslated__Z29test_rsqrt_approx_ftz_f64_infPd( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%r2 = bitcast double 0x7ff0000000000000 to double;
