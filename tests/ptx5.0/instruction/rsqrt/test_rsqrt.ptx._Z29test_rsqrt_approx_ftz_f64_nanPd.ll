...
define default void @_Z_ocelotTranslated__Z29test_rsqrt_approx_ftz_f64_nanPd( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_8_2:
	...
	%r2 = bitcast double 0x7ff8000000000000 to double;
