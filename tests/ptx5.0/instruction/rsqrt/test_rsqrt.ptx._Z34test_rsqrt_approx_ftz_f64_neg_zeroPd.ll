...
define default void @_Z_ocelotTranslated__Z34test_rsqrt_approx_ftz_f64_neg_zeroPd( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_7_2:
	...
	%r2 = bitcast double 0x8000000000000000 to double;
