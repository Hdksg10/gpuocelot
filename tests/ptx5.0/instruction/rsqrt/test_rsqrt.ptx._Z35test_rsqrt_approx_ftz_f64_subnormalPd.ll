...
define default void @_Z_ocelotTranslated__Z35test_rsqrt_approx_ftz_f64_subnormalPd( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_2_2:
	...
	%r2 = bitcast double 0xfffffffffffff to double;
