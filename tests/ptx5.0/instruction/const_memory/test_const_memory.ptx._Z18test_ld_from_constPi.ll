...
define default void @_Z_ocelotTranslated__Z18test_ld_from_constPi( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_3_2:
	...
	br i1 %r5, label %BB_3_4, label %BB_3_3;
BB_3_3:
	...
	%rt14 = add i64 %r11, %rt13;
	%rt15 = inttoptr i64 %rt14 to i32*;
	%r12 = load i32, i32* %rt15, align 4;
	%r13 = add i64 %r8, %r9;
	%rt16 = inttoptr i64 %r13 to i32*;
	store i32 %r12, i32* %rt16, align 4;
	br label %BB_3_4;
BB_3_4:
	%rt17 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt18 = load i8*, i8** %rt17;
	%rt19 = bitcast i8* %rt18 to i32*;
	store i32 2, i32* %rt19;
	br label %BB_3_1;
BB_3_1:
	ret void;
