...
namespace test {
    class TestInstructionConstMemory : public TestInstruction {
    public:

        TestInstructionConstMemory() {
            name = "TestInstructionConstMemory";
...
int main( int argc, char** argv )
{
	...
	test::TestInstructionConstMemory test;
	parser.description( test.testDescription() );

	parser.parse("-c", test.configPath, "../instruction/const_memory/config.test", "Test configuration path.");
	parser.parse( "-i", test.input, "../instruction/const_memory/test_const_memory.ptx",
		"Test PTX path.");
