...
define default void @_Z_ocelotTranslated__Z13test_fmaf16x2P7__half2S0_S0_S0_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_5_2:
	...
	%rt15 = bitcast i32 %r8 to < 2 x half >;
	%rt16 = bitcast i32 %r9 to < 2 x half >;
	%rt18 = bitcast i32 %r10 to < 2 x half >;
	%rt17 = fmul < 2 x half > %rt15, %rt16;
	%rt19 = fadd < 2 x half > %rt17, %rt18;
	%r11 = bitcast < 2 x half > %rt19 to i32;
	%rt20 = inttoptr i64 %r4 to i32*;
	store i32 %r11, i32* %rt20, align 4;
