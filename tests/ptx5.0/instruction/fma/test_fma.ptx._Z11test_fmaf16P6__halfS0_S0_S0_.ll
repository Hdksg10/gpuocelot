...
define default void @_Z_ocelotTranslated__Z11test_fmaf16P6__halfS0_S0_S0_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_1_2:
	...
	%r4 = bitcast i64 %r0 to i64;
	%r5 = bitcast i64 %r3 to i64;
	%r6 = bitcast i64 %r2 to i64;
	%r7 = bitcast i64 %r1 to i64;
	%rt12 = inttoptr i64 %r7 to i16*;
	%r8 = load i16, i16* %rt12, align 2;
	%rt13 = inttoptr i64 %r6 to i16*;
	%r9 = load i16, i16* %rt13, align 2;
	%rt14 = inttoptr i64 %r5 to i16*;
	%r10 = load i16, i16* %rt14, align 2;
	%rt15 = bitcast i16 %r8 to half;
	%rt16 = bitcast i16 %r9 to half;
	%rt17 = bitcast i16 %r10 to half;
	%rt18 = fmul half %rt15, %rt16;
	%rt19 = fadd half %rt18, %rt17;
	%r11 = bitcast half %rt19 to i16;
	%rt20 = inttoptr i64 %r4 to i16*;
	store i16 %r11, i16* %rt20, align 2;
