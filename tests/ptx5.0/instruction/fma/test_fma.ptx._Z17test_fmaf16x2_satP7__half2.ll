...
define default void @_Z_ocelotTranslated__Z17test_fmaf16x2_satP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_6_2:
	...
	%r3 = bitcast i32 67058688 to i32;
	%r4 = bitcast i32 -1140769792 to i32;
	%rt3 = bitcast i32 %r2 to < 2 x half >;
	%rt4 = bitcast i32 %r3 to < 2 x half >;
	%rt6 = bitcast i32 %r4 to < 2 x half >;
	%rt5 = fmul < 2 x half > %rt3, %rt4;
	%rt7 = fadd < 2 x half > %rt5, %rt6;
	%rt9 = fcmp ult < 2 x half > %rt7, < half 0xH0, half 0xH0 >;
	%rt10 = select < 2 x i1 > %rt9, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt7;
	%rt11 = fcmp ogt < 2 x half > %rt7, < half 0xH3c00, half 0xH3c00 >;
	%rt8 = select < 2 x i1 > %rt11, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > %rt10;
	%r5 = bitcast < 2 x half > %rt8 to i32;
