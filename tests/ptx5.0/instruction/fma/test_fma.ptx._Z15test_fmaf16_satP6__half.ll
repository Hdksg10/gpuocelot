...
define default void @_Z_ocelotTranslated__Z15test_fmaf16_satP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_2_2:
	...
	%rt6 = fmul half %rt3, %rt4;
	%rt7 = fadd half %rt6, %rt5;
	%rt9 = fcmp ult half %rt7, 0xH0;
	%rt10 = select i1 %rt9, half 0xH0, half %rt7;
	%rt11 = fcmp ogt half %rt7, 0xH3c00;
	%rt8 = select i1 %rt11, half 0xH3c00, half %rt10;
	%r4 = bitcast half %rt8 to i16;
	%rt12 = inttoptr i64 %r1 to i16*;
	store i16 %r4, i16* %rt12, align 2;
