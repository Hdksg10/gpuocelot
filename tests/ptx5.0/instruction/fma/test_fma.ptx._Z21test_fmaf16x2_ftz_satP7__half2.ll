...
define default void @_Z_ocelotTranslated__Z21test_fmaf16x2_ftz_satP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_8_2:
	...
	%r2 = bitcast i32 1006633983 to i32;
	%r3 = bitcast i32 -2079704064 to i32;
	%r4 = bitcast i32 1006648320 to i32;
	%rt3 = bitcast i32 %r2 to < 2 x half >;
	%rt4 = bitcast i32 %r3 to < 2 x half >;
	%rt6 = bitcast i32 %r4 to < 2 x half >;
	...
	%rt31 = fcmp olt < 2 x half > %rt7, < half 0xH0, half 0xH0 >;
	%rt33 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt7;
	%rt35 = select < 2 x i1 > %rt31, < 2 x half > %rt33, < 2 x half > %rt7;
	%rt36 = fcmp olt < 2 x half > %rt35, < half 0xH400, half 0xH400 >;
	%rt29 = select < 2 x i1 > %rt36, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt7;
	%rt37 = fcmp ult < 2 x half > %rt29, < half 0xH0, half 0xH0 >;
	%rt38 = select < 2 x i1 > %rt37, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt29;
	%rt39 = fcmp ogt < 2 x half > %rt29, < half 0xH3c00, half 0xH3c00 >;
	%rt30 = select < 2 x i1 > %rt39, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > %rt38;
	%r5 = bitcast < 2 x half > %rt30 to i32;
	%rt40 = inttoptr i64 %r1 to i32*;
	store i32 %r5, i32* %rt40, align 4;
	%rt41 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt42 = load i8*, i8** %rt41;
	%rt43 = bitcast i8* %rt42 to i32*;
	store i32 2, i32* %rt43;
	br label %BB_8_1;
BB_8_1:
	ret void;
