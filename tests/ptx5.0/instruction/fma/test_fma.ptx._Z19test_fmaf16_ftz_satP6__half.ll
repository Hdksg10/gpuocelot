...
define default void @_Z_ocelotTranslated__Z19test_fmaf16_ftz_satP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%r4 = bitcast i16 15370 to i16;
	%rt3 = bitcast i16 %r2 to half;
	%rt4 = bitcast i16 %r3 to half;
	%rt5 = bitcast i16 %r4 to half;
	...
	%rt25 = fcmp olt half %rt22, 0xH0;
	%rt26 = fsub half 0xH0, %rt22;
	%rt27 = select i1 %rt25, half %rt26, half %rt22;
	%rt28 = fcmp olt half %rt27, 0xH400;
	%rt23 = select i1 %rt28, half 0xH0, half %rt22;
	%rt29 = fcmp ult half %rt23, 0xH0;
	%rt30 = select i1 %rt29, half 0xH0, half %rt23;
	%rt31 = fcmp ogt half %rt23, 0xH3c00;
	%rt24 = select i1 %rt31, half 0xH3c00, half %rt30;
	%r5 = bitcast half %rt24 to i16;
	%rt32 = inttoptr i64 %r1 to i16*;
	store i16 %r5, i16* %rt32, align 2;
	%rt33 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt34 = load i8*, i8** %rt33;
	%rt35 = bitcast i8* %rt34 to i32*;
	store i32 2, i32* %rt35;
	br label %BB_4_1;
BB_4_1:
	ret void;
