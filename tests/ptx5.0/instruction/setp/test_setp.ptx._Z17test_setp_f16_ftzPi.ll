...
define default void @_Z_ocelotTranslated__Z17test_setp_f16_ftzPi( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_2_2:
	...
	%rt3 = bitcast i16 %r3 to half;
	%rt5 = fcmp olt half %rt3, 0xH0;
	%rt6 = fsub half 0xH0, %rt3;
	%rt7 = select i1 %rt5, half %rt6, half %rt3;
	%rt8 = fcmp olt half %rt7, 0xH400;
	%rt4 = select i1 %rt8, half 0xH0, half %rt3;
	%rt9 = bitcast i16 %r4 to half;
	%rt11 = fcmp olt half %rt9, 0xH0;
	%rt12 = fsub half 0xH0, %rt9;
	%rt13 = select i1 %rt11, half %rt12, half %rt9;
	%rt14 = fcmp olt half %rt13, 0xH400;
	%rt10 = select i1 %rt14, half 0xH0, half %rt9;
	%r5 = fcmp oeq half %rt4, %rt10;
	%r6 = bitcast i32 1 to i32;
	%r7 = select i1 %r5, i32 %r6, i32 %r0;
	%rt15 = inttoptr i64 %r2 to i32*;
