...
define default void @_Z_ocelotTranslated__Z13test_setp_f16PiP6__halfS1_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_1_2:
	...
	%r2 = load i64, i64* %rt5, align 8;
	%rt6 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 7;
	%rt7 = load i8*, i8** %rt6;
	%rt8 = bitcast i8* %rt7 to i64*;
	%r3 = load i64, i64* %rt8, align 8;
	%r4 = bitcast i64 %r1 to i64;
	%r5 = bitcast i64 %r3 to i64;
	%r6 = bitcast i64 %r2 to i64;
	%rt9 = inttoptr i64 %r6 to i16*;
	%r7 = load i16, i16* %rt9, align 2;
	%rt10 = inttoptr i64 %r5 to i16*;
	%r8 = load i16, i16* %rt10, align 2;
	%rt11 = bitcast i16 %r7 to half;
	%rt12 = bitcast i16 %r8 to half;
	%r9 = fcmp one half %rt11, %rt12;
	%r10 = bitcast i32 1 to i32;
	%r11 = select i1 %r9, i32 %r10, i32 %r0;
	%rt13 = inttoptr i64 %r4 to i32*;
	store i32 %r11, i32* %rt13, align 4;
	%rt14 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt15 = load i8*, i8** %rt14;
	%rt16 = bitcast i8* %rt15 to i32*;
	store i32 2, i32* %rt16;
	br label %BB_1_1;
BB_1_1:
	ret void;
