...
define default void @_Z_ocelotTranslated__Z24test_setp_f16_boolop_ftzPi( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_4_2:
	...
	%r3 = bitcast i16 1023 to i16;
	%r4 = bitcast i16 1022 to i16;
	%r5 = icmp eq i32 1, 34;
	...
	%r6 = xor i1 %r5, %rt3;
	%r7 = bitcast i32 1 to i32;
	%r8 = select i1 %r6, i32 %r7, i32 %r0;
	%rt16 = inttoptr i64 %r2 to i32*;
