...
define default void @_Z_ocelotTranslated__Z15test_setp_f16x2PiP7__half2S1_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_5_2:
	...
	%r3 = load i64, i64* %rt5, align 8;
	%rt6 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 7;
	%rt7 = load i8*, i8** %rt6;
	%rt8 = bitcast i8* %rt7 to i64*;
	%r4 = load i64, i64* %rt8, align 8;
	%r5 = bitcast i64 %r2 to i64;
	%r6 = bitcast i64 %r4 to i64;
	%r7 = bitcast i64 %r3 to i64;
	%rt9 = inttoptr i64 %r7 to i32*;
	%r8 = load i32, i32* %rt9, align 4;
	%rt10 = inttoptr i64 %r6 to i32*;
	%r9 = load i32, i32* %rt10, align 4;
	%rt12 = bitcast i32 %r8 to < 2 x half >;
	%rt13 = bitcast i32 %r9 to < 2 x half >;
	%rt11 = fcmp one < 2 x half > %rt12, %rt13;
	%r11 = extractelement < 2 x i1 > %rt11, i32 0;
	%r10 = extractelement < 2 x i1 > %rt11, i32 1;
	%r12 = bitcast i32 1 to i32;
	%r13 = select i1 %r11, i32 %r12, i32 %r0;
	%r14 = bitcast i32 2 to i32;
	%r15 = select i1 %r10, i32 %r14, i32 %r1;
	%r16 = add i32 %r13, %r15;
	%rt14 = inttoptr i64 %r5 to i32*;
	store i32 %r16, i32* %rt14, align 4;
