...
define default void @_Z_ocelotTranslated__Z26test_setp_f16x2_boolop_ftzPi( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_8_2:
	...
	%rt13 = bitcast i32 %r5 to < 2 x half >;
	...
	%r8 = xor i1 %r6, %rt3;
	%r7 = xor i1 %r6, %rt21;
	%r9 = bitcast i32 1 to i32;
	%r10 = select i1 %r8, i32 %r9, i32 %r0;
	%r11 = bitcast i32 2 to i32;
	%r12 = select i1 %r7, i32 %r11, i32 %r1;
	%r13 = add i32 %r10, %r12;
	%rt22 = inttoptr i64 %r3 to i32*;
	store i32 %r13, i32* %rt22, align 4;
