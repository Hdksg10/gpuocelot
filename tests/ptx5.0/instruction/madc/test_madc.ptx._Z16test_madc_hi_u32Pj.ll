...
define default void @_Z_ocelotTranslated__Z16test_madc_hi_u32Pj( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_2_2:
	...
	%r3 = bitcast i32 131072 to i32;
	%r4 = bitcast i32 -1 to i32;
	%rt3 = zext i32 %r3 to i64;
	%rt4 = zext i32 %r3 to i64;
	%rt5 = mul i64 %rt3, %rt4;
	%rt6 = lshr i64 %rt5, 32;
	%rt7 = trunc i64 %rt6 to i32;
	%rt8 = add i32 %rt7, %r4;
	%r6 = add i32 %rt8, %r0;
	%rt9 = icmp ult i32 %r6, %rt7;
	%rt10 = icmp ult i32 %r6, %r4;
	%rt11 = or i1 %rt9, %rt10;
	%r5 = select i1 %rt11, i32 1, i32 0;
	%rt12 = zext i32 %r3 to i64;
	...
	%rt17 = add i32 %rt16, 0;
	%r7 = add i32 %rt17, %r5;
	%rt18 = inttoptr i64 %r2 to i32*;
	store i32 %r7, i32* %rt18, align 4;
