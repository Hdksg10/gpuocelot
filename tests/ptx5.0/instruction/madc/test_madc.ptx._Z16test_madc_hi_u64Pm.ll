...
define default void @_Z_ocelotTranslated__Z16test_madc_hi_u64Pm( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_4_2:
	...
	%r3 = bitcast i64 8589934592 to i64;
	%r4 = bitcast i64 -1 to i64;
	%rt3 = call i64 @__ocelot_mul_hi_u64(i64 %r3, i64 %r3);
	%rt4 = add i64 %rt3, %r4;
	%rt5 = sext i32 %r0 to i64;
	%r6 = add i64 %rt4, %rt5;
	%rt6 = icmp ult i64 %r6, %rt3;
	%rt7 = icmp ult i64 %r6, %r4;
	%rt8 = or i1 %rt6, %rt7;
	%r5 = select i1 %rt8, i32 1, i32 0;
	%rt9 = call i64 @__ocelot_mul_hi_u64(i64 %r3, i64 %r3);
	%rt10 = add i64 %rt9, 0;
	%rt11 = sext i32 %r5 to i64;
	%r7 = add i64 %rt10, %rt11;
	%rt12 = inttoptr i64 %r2 to i64*;
	store i64 %r7, i64* %rt12, align 8;
	%rt13 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt14 = load i8*, i8** %rt13;
	%rt15 = bitcast i8* %rt14 to i32*;
	store i32 2, i32* %rt15;
	br label %BB_4_1;
BB_4_1:
	ret void;
