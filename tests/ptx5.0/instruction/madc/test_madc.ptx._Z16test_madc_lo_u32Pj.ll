...
define default void @_Z_ocelotTranslated__Z16test_madc_lo_u32Pj( %LLVMContext* %__ctaContext ) nounwind align 1;
{
...
BB_1_2:
	...
	%r3 = bitcast i32 2 to i32;
	%r4 = bitcast i32 -1 to i32;
	%rt3 = mul i32 %r3, %r3;
	%rt4 = add i32 %r4, %rt3;
	%r6 = add i32 %rt4, %r0;
	%rt5 = icmp ult i32 %r6, %rt3;
	%rt6 = icmp ult i32 %r6, %r4;
	%rt7 = or i1 %rt5, %rt6;
	%r5 = select i1 %rt7, i32 1, i32 0;
	%rt8 = mul i32 %r3, %r3;
	%rt9 = add i32 0, %rt8;
	%r7 = add i32 %rt9, %r5;
	%rt10 = inttoptr i64 %r2 to i32*;
	store i32 %r7, i32* %rt10, align 4;
