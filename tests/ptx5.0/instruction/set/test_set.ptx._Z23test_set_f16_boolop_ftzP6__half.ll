...
define default void @_Z_ocelotTranslated__Z23test_set_f16_boolop_ftzP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%r3 = bitcast i16 1022 to i16;
	%r4 = icmp eq i32 1, 34;
	%rt4 = bitcast i16 %r2 to half;
	%rt6 = fcmp olt half %rt4, 0xH0;
	%rt7 = fsub half 0xH0, %rt4;
	%rt8 = select i1 %rt6, half %rt7, half %rt4;
	%rt9 = fcmp olt half %rt8, 0xH400;
	%rt5 = select i1 %rt9, half 0xH0, half %rt4;
	%rt10 = bitcast i16 %r3 to half;
	%rt12 = fcmp olt half %rt10, 0xH0;
	%rt13 = fsub half 0xH0, %rt10;
	%rt14 = select i1 %rt12, half %rt13, half %rt10;
	%rt15 = fcmp olt half %rt14, 0xH400;
	%rt11 = select i1 %rt15, half 0xH0, half %rt10;
	%rt3 = fcmp oeq half %rt5, %rt11;
	%rt16 = xor i1 %r4, %rt3;
	%rt17 = select i1 %rt16, half 0xH3c00, half 0xH0;
	%r5 = bitcast half %rt17 to i16;
	%rt18 = inttoptr i64 %r1 to i16*;
	store i16 %r5, i16* %rt18, align 2;
	%rt19 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt20 = load i8*, i8** %rt19;
	%rt21 = bitcast i8* %rt20 to i32*;
	store i32 2, i32* %rt21;
	br label %BB_4_1;
BB_4_1:
	ret void;
