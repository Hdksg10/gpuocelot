...
namespace test {
    class TestInstructionSet : public TestInstruction {
    public:

	TestInstructionSet() {
            name = "TestInstructionSet";
...
int main( int argc, char** argv )
{
	...
	test::TestInstructionSet test;
	parser.description( test.testDescription() );

	parser.parse("-c", test.configPath, "../instruction/set/config_f16.test", "Test configuration path.");
	parser.parse( "-i", test.input, "../instruction/set/test_set.ptx",
		"Test PTX path.");
