...
define default void @_Z_ocelotTranslated__Z18test_set_f16x2_ftzP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_6_2:
	...
	%rt20 = select < 2 x i1 > %rt3, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > < half 0xH0, half 0xH0 >;
	%r4 = bitcast < 2 x half > %rt20 to i32;
	%rt21 = inttoptr i64 %r1 to i32*;
	store i32 %r4, i32* %rt21, align 4;
