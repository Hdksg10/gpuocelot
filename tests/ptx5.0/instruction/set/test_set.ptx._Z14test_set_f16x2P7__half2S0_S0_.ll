...
define default void @_Z_ocelotTranslated__Z14test_set_f16x2P7__half2S0_S0_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_5_2:
	...
	%rt12 = bitcast i32 %r6 to < 2 x half >;
	%rt13 = bitcast i32 %r7 to < 2 x half >;
	%rt11 = fcmp oge < 2 x half > %rt12, %rt13;
	%rt14 = select < 2 x i1 > %rt11, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > < half 0xH0, half 0xH0 >;
	%r8 = bitcast < 2 x half > %rt14 to i32;
	%rt15 = inttoptr i64 %r3 to i32*;
