...
define default void @_Z_ocelotTranslated__Z16test_set_f16_ftzP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_2_2:
	...
	%rt16 = select i1 %rt3, half 0xH3c00, half 0xH0;
	%r4 = bitcast half %rt16 to i16;
	%rt17 = inttoptr i64 %r1 to i16*;
	store i16 %r4, i16* %rt17, align 2;
