...
define default void @_Z_ocelotTranslated__Z21test_set_f16x2_boolopP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_7_2:
	...
	%rt5 = bitcast i32 %r2 to < 2 x half >;
	%rt3 = fcmp oeq < 2 x half > %rt4, %rt5;
	%rt6 = sext i1 %r3 to i8;
	%rt7 = bitcast i8 %rt6 to < 8 x i1 >;
	%rt8 = shufflevector < 8 x i1 > %rt7, < 8 x i1 > %rt7, < 2 x i32 > < i32 0, i32 1 >;
	%rt9 = and < 2 x i1 > %rt8, %rt3;
	%rt10 = select < 2 x i1 > %rt9, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > < half 0xH0, half 0xH0 >;
	%r4 = bitcast < 2 x half > %rt10 to i32;
