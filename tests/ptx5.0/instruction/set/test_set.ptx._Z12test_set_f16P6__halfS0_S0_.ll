...
define default void @_Z_ocelotTranslated__Z12test_set_f16P6__halfS0_S0_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_1_2:
	...
	%rt11 = fcmp oge half %rt12, %rt13;
	%rt14 = select i1 %rt11, half 0xH3c00, half 0xH0;
