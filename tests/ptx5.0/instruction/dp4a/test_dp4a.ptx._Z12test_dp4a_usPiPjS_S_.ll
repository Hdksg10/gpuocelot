...
define default void @_Z_ocelotTranslated__Z12test_dp4a_usPiPjS_S_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_2_2:
	...
	%rt17 = sext < 4 x i8 > %rt15 to < 4 x i32 >;
	%rt18 = sext < 4 x i8 > %rt16 to < 4 x i32 >;
