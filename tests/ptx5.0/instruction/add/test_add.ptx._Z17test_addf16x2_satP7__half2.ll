...
define default void @_Z_ocelotTranslated__Z17test_addf16x2_satP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_7_2:
	...
	%r2 = bitcast i32 1006386175 to i32;
	%r3 = bitcast i32 1006713856 to i32;
	%rt3 = bitcast i32 %r2 to < 2 x half >;
	%rt4 = bitcast i32 %r3 to < 2 x half >;
	%rt5 = fadd < 2 x half > %rt3, %rt4;
