...
define default void @_Z_ocelotTranslated__Z17test_addf16x2_ftzP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_8_2:
	...
	%rt29 = fcmp olt < 2 x half > %rt5, < half 0xH0, half 0xH0 >;
	%rt31 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt5;
	%rt33 = select < 2 x i1 > %rt29, < 2 x half > %rt31, < 2 x half > %rt5;
	%rt34 = fcmp olt < 2 x half > %rt33, < half 0xH400, half 0xH400 >;
	%rt35 = select < 2 x i1 > %rt34, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt5;
	%rt36 = bitcast < 2 x half > %rt5 to < 2 x i16 >;
	%rt37 = icmp slt < 2 x i16 > %rt36, < i16 0, i16 0 >;
	%rt38 = and < 2 x i1 > %rt37, %rt34;
	%rt28 = select < 2 x i1 > %rt38, < 2 x half > < half 0xH8000, half 0xH8000 >, < 2 x half > %rt35;
	%r3 = bitcast < 2 x half > %rt28 to i32;
	%rt39 = inttoptr i64 %r1 to i32*;
	store i32 %r3, i32* %rt39, align 4;
	%rt40 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt41 = load i8*, i8** %rt40;
	%rt42 = bitcast i8* %rt41 to i32*;
	store i32 2, i32* %rt42;
	br label %BB_8_1;
BB_8_1:
	ret void;
