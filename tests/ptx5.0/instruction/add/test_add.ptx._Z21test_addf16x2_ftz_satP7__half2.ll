...
define default void @_Z_ocelotTranslated__Z21test_addf16x2_ftz_satP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_9_2:
	...
	%r2 = bitcast i32 66978815 to i32;
	%r3 = bitcast i32 -2079685631 to i32;
	%rt3 = bitcast i32 %r2 to < 2 x half >;
	%rt4 = bitcast i32 %r3 to < 2 x half >;
	%rt8 = fcmp olt < 2 x half > %rt3, < half 0xH0, half 0xH0 >;
	%rt10 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt3;
	%rt12 = select < 2 x i1 > %rt8, < 2 x half > %rt10, < 2 x half > %rt3;
	%rt13 = fcmp olt < 2 x half > %rt12, < half 0xH400, half 0xH400 >;
	%rt14 = select < 2 x i1 > %rt13, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt3;
	%rt15 = bitcast < 2 x half > %rt3 to < 2 x i16 >;
	%rt16 = icmp slt < 2 x i16 > %rt15, < i16 0, i16 0 >;
	%rt17 = and < 2 x i1 > %rt16, %rt13;
	%rt6 = select < 2 x i1 > %rt17, < 2 x half > < half 0xH8000, half 0xH8000 >, < 2 x half > %rt14;
	%rt18 = fcmp olt < 2 x half > %rt4, < half 0xH0, half 0xH0 >;
	%rt20 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt4;
	%rt22 = select < 2 x i1 > %rt18, < 2 x half > %rt20, < 2 x half > %rt4;
	%rt23 = fcmp olt < 2 x half > %rt22, < half 0xH400, half 0xH400 >;
	%rt24 = select < 2 x i1 > %rt23, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt4;
	%rt25 = bitcast < 2 x half > %rt4 to < 2 x i16 >;
	%rt26 = icmp slt < 2 x i16 > %rt25, < i16 0, i16 0 >;
	%rt27 = and < 2 x i1 > %rt26, %rt23;
	%rt7 = select < 2 x i1 > %rt27, < 2 x half > < half 0xH8000, half 0xH8000 >, < 2 x half > %rt24;
	%rt5 = fadd < 2 x half > %rt6, %rt7;
	%rt30 = fcmp olt < 2 x half > %rt5, < half 0xH0, half 0xH0 >;
	%rt32 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt5;
	%rt34 = select < 2 x i1 > %rt30, < 2 x half > %rt32, < 2 x half > %rt5;
	%rt35 = fcmp olt < 2 x half > %rt34, < half 0xH400, half 0xH400 >;
	%rt36 = select < 2 x i1 > %rt35, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt5;
	%rt37 = bitcast < 2 x half > %rt5 to < 2 x i16 >;
	%rt38 = icmp slt < 2 x i16 > %rt37, < i16 0, i16 0 >;
	%rt39 = and < 2 x i1 > %rt38, %rt35;
	%rt28 = select < 2 x i1 > %rt39, < 2 x half > < half 0xH8000, half 0xH8000 >, < 2 x half > %rt36;
	%rt40 = fcmp ult < 2 x half > %rt28, < half 0xH0, half 0xH0 >;
	%rt41 = select < 2 x i1 > %rt40, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt28;
	%rt42 = fcmp ogt < 2 x half > %rt28, < half 0xH3c00, half 0xH3c00 >;
	%rt29 = select < 2 x i1 > %rt42, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > %rt41;
	%r4 = bitcast < 2 x half > %rt29 to i32;
	%rt43 = inttoptr i64 %r1 to i32*;
	store i32 %r4, i32* %rt43, align 4;
	%rt44 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt45 = load i8*, i8** %rt44;
	%rt46 = bitcast i8* %rt45 to i32*;
	store i32 2, i32* %rt46;
	br label %BB_9_1;
BB_9_1:
	ret void;
