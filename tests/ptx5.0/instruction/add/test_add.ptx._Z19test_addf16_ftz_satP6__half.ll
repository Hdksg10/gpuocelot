...
define default void @_Z_ocelotTranslated__Z19test_addf16_ftz_satP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_5_2:
	...
	%rt27 = fcmp olt half %rt6, 0xH0;
	%rt28 = fsub half 0xH0, %rt6;
	%rt29 = select i1 %rt27, half %rt28, half %rt6;
	%rt30 = fcmp olt half %rt29, 0xH400;
	%rt31 = select i1 %rt30, half 0xH0, half %rt6;
	%rt32 = bitcast half %rt6 to i16;
	%rt33 = icmp slt i16 %rt32, 0;
	%rt34 = and i1 %rt33, %rt30;
	%rt25 = select i1 %rt34, half 0xH8000, half %rt31;
	%rt35 = fcmp ult half %rt25, 0xH0;
	%rt36 = select i1 %rt35, half 0xH0, half %rt25;
	%rt37 = fcmp ogt half %rt25, 0xH3c00;
	%rt26 = select i1 %rt37, half 0xH3c00, half %rt36;
	%r4 = bitcast half %rt26 to i16;
	%rt38 = inttoptr i64 %r1 to i16*;
	store i16 %r4, i16* %rt38, align 2;
	%rt39 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt40 = load i8*, i8** %rt39;
	%rt41 = bitcast i8* %rt40 to i32*;
	store i32 2, i32* %rt41;
	br label %BB_5_1;
BB_5_1:
	ret void;
