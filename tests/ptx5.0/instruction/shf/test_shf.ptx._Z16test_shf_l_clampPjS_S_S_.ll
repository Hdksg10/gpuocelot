...
define default void @_Z_ocelotTranslated__Z16test_shf_l_clampPjS_S_S_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_1_2:
	...
	%rt18 = shl i32 %r9, %rt16;
	%rt19 = lshr i32 %r8, %rt17;
	%rt20 = or i32 %rt19, %rt18;
	%r11 = select i1 %rt15, i32 %rt20, i32 %r8;
