...
define default void @_Z_ocelotTranslated__Z15test_shf_r_wrapPjS_S_S_( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%rt15 = and i32 %r10, 31;
	%rt16 = sub i32 32, %rt15;
	%rt17 = shl i32 %r9, %rt16;
	%rt18 = lshr i32 %r8, %rt15;
	%r11 = or i32 %rt18, %rt17;
	%rt19 = inttoptr i64 %r4 to i32*;
	store i32 %r11, i32* %rt19, align 4;
