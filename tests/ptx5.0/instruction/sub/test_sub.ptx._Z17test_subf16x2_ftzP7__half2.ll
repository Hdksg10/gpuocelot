...
define default void @_Z_ocelotTranslated__Z17test_subf16x2_ftzP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_8_2:
	...
	%r2 = bitcast i32 67109887 to i32;
	%r3 = bitcast i32 66978817 to i32;
	...
	%rt21 = fcmp olt < 2 x half > %rt5, < half 0xH0, half 0xH0 >;
	%rt23 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt5;
	%rt25 = select < 2 x i1 > %rt21, < 2 x half > %rt23, < 2 x half > %rt5;
	%rt26 = fcmp olt < 2 x half > %rt25, < half 0xH400, half 0xH400 >;
	%rt20 = select < 2 x i1 > %rt26, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt5;
	%r4 = bitcast < 2 x half > %rt20 to i32;
	%rt27 = inttoptr i64 %r1 to i32*;
	store i32 %r4, i32* %rt27, align 4;
