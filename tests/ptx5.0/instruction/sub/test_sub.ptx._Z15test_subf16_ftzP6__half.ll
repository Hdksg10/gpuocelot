...
define default void @_Z_ocelotTranslated__Z15test_subf16_ftzP6__half( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_4_2:
	...
	%r4 = bitcast half %rt17 to i16;
	%rt22 = inttoptr i64 %r1 to i16*;
	store i16 %r4, i16* %rt22, align 2;
