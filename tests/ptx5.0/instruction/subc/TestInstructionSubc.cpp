...
namespace test {
    ...
    public:
        ...
        TestInstructionSubC() {
            name = "TestInstructionSubC";

            description = "A unit test for the SUBC instruction.";
        }
    protected:
...
int main( int argc, char** argv )
{
	...
	parser.parse("-c", test.configPath, "../instruction/subc/config.test", "Test configuration path.");
	parser.parse( "-i", test.input, "../instruction/subc/test_subc.ptx",
		"Test PTX path.");
