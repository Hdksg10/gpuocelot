...
define default void @_Z_ocelotTranslated__Z21test_mulf16x2_ftz_satP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_8_2:
	...
	%rt6 = select < 2 x i1 > %rt13, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt3;
	%rt14 = fcmp olt < 2 x half > %rt4, < half 0xH0, half 0xH0 >;
	%rt16 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt4;
	%rt18 = select < 2 x i1 > %rt14, < 2 x half > %rt16, < 2 x half > %rt4;
	%rt19 = fcmp olt < 2 x half > %rt18, < half 0xH400, half 0xH400 >;
	%rt7 = select < 2 x i1 > %rt19, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt4;
	%rt5 = fmul < 2 x half > %rt6, %rt7;
	%rt22 = fcmp olt < 2 x half > %rt5, < half 0xH0, half 0xH0 >;
	%rt24 = fsub < 2 x half > < half 0xH0, half 0xH0 >, %rt5;
	%rt26 = select < 2 x i1 > %rt22, < 2 x half > %rt24, < 2 x half > %rt5;
	%rt27 = fcmp olt < 2 x half > %rt26, < half 0xH400, half 0xH400 >;
	%rt20 = select < 2 x i1 > %rt27, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt5;
	%rt28 = fcmp ult < 2 x half > %rt20, < half 0xH0, half 0xH0 >;
	%rt29 = select < 2 x i1 > %rt28, < 2 x half > < half 0xH0, half 0xH0 >, < 2 x half > %rt20;
	%rt30 = fcmp ogt < 2 x half > %rt20, < half 0xH3c00, half 0xH3c00 >;
	%rt21 = select < 2 x i1 > %rt30, < 2 x half > < half 0xH3c00, half 0xH3c00 >, < 2 x half > %rt29;
	%r4 = bitcast < 2 x half > %rt21 to i32;
	%rt31 = inttoptr i64 %r1 to i32*;
	store i32 %r4, i32* %rt31, align 4;
	%rt32 = getelementptr %LLVMContext, %LLVMContext* %__ctaContext, i32 0, i32 4;
	%rt33 = load i8*, i8** %rt32;
	%rt34 = bitcast i8* %rt33 to i32*;
	store i32 2, i32* %rt34;
	br label %BB_8_1;
BB_8_1:
	ret void;
