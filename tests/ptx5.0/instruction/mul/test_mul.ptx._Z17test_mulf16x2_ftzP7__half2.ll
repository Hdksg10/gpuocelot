...
define default void @_Z_ocelotTranslated__Z17test_mulf16x2_ftzP7__half2( %LLVMContext* %__ctaContext ) nounwind align 1;
{
BB_7_2:
	...
	%r3 = bitcast < 2 x half > %rt20 to i32;
	%rt27 = inttoptr i64 %r1 to i32*;
	store i32 %r3, i32* %rt27, align 4;
